...
(function ($, window, undefined) {
	...
	function mightySlider(frame, options, callbackMap) {
		...
		function scaleSlider() {
			...
			if (parentSize <= 425){
				...
				var ratio = parentSize / autoScale.width;
			}
	...
	*/
	...
	mightySlider.defaults = {
		...
		autoResize:         true,      // Auto resize the slider when active slide is bigger than slider FRAME.
		...
		classes: {
			...
			// change from disabled to disabling
			disabledClass:       'disabling',       // Class for disabled navigation elements.
